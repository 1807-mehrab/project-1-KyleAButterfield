...
@WebServlet(name ="GetEveryPendingRequest", urlPatterns=("/getEveryPendingRequest"))
public class GetEveryPendingRequestServlet extends HttpServlet {
	protected void doPost (HttpServletRequest req, HttpServletResponse resp)
		...
		requests = rrdao.getAllPendingRequests();
