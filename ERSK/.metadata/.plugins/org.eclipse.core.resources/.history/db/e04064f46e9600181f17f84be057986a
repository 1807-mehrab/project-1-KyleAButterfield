...
public class CreateImageServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		System.out.println("This is the imageID: "+img.getImageId());
		System.out.println("This is reimburseID: " + img.getReimburseId());
		idao.createImage(img.getReimburseId(), img.getImage());
	}
}