...
@WebServlet(name ="GetAllDeniedUserRequestsForAdmin", urlPatterns=("/getAllDeniedRequestsForAdmin"))
public class GetAllDeniedUserRequestsForAdminServlet extends HttpServlet {
	protected void doPost (HttpServletRequest req, HttpServletResponse resp)
		...
		requests = rrdao.getAllDeniedRequestsOfUser(id);
