...
@WebServlet(name ="GetAllResolvedUserRequestsForAdmin", urlPatterns=("/getAllResolvedRequestsForAdmin"))
public class GetAllResolvedUserRequestsForAdminServlet extends HttpServlet {
