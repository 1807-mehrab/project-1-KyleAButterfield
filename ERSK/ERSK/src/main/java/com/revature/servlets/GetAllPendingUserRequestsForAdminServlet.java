...
@WebServlet(name ="GetAllPendingUserRequestsForAdmin", urlPatterns=("/getAllPendingRequestsForAdmin"))
public class GetAllPendingUserRequestsForAdminServlet extends HttpServlet {
	protected void doPost (HttpServletRequest req, HttpServletResponse resp)
		...
		requests = rrdao.getAllPendingRequestsOfUser(id);
